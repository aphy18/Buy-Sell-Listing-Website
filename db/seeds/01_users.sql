...
('suburban truck', 2021, 'army camo', 'SUV', '2 ft off the ground solid rock traversing vechile', 180000, false, NULL),
('trailer-g2', 2008, 'white', 'Timmy Trailers', 'good for a camping trip, no refunds included', 5500, false, NULL),
('speed demon 3000 to boat convertible', 2025, 'steel-white', 'f1-racing', 'a car never to thought exist before', 15000050, false, NULL),
('4 wheeler delta', 2004, 'crimson', 'Duggys Durby', 'An old dog with new tricks', 25000, false, NULL),
('tricycle', 2012, 'lucky-red', 'trikes for kids', 'Good for kids ages 3-6', 40, false, NULL),
('1998 Bently', 1998, 'grey', 'Bently', 'A good old relic of the past', 7600, false, NULL);
