...
VALUES ('/images/image.jpeg','honda civic', 2002, 'black', 'Honda', 'slowest car around', 5000, false, NULL),
('/images/image.jpeg','lamborghini turbo v3', 2019, 'blue', 'lamborghini', 'sonic fast with added turbo extensions', 1200000, false, NULL),
('/images/image.jpeg','maserati fusion', 2015, 'teel', 'maserati', 'perfect car for a friday night date', 200000, false, NULL),
('/images/image.jpeg','suburban truck', 2021, 'army camo', 'SUV', '2 ft off the ground solid rock traversing vechile', 180000, false, NULL),
('/images/image.jpeg','trailer-g2', 2008, 'white', 'Timmy Trailers', 'good for a camping trip, no refunds included', 5500, false, NULL),
('/images/image.jpeg','speed demon 3000 to boat convertible', 2025, 'steel-white', 'f1-racing', 'a car never to thought exist before', 15000050, false, NULL),
('/images/image.jpeg','4 wheeler delta', 2004, 'crimson', 'Duggys Durby', 'An old dog with new tricks', 25000, false, NULL),
